...
while ($gen = $genre->getResult()) {
    ...
    <td style="font-size: 22px;">
        <a href="genre.php?id=' . $gen['genre_id'] . '" title="Edit Data"><i class="bi bi-pencil-square text-warning"></i></a>&nbsp;<a href="genre.php?hapus=' . $gen['genre_id'] . '" title="Delete Data"><i class="bi bi-trash-fill text-danger"></i></a>
        </td>
    </tr>';
    $no++;
}
